/**
 * \file
 * \brief	Userspace deamon for the userspace-initiated netlink ping pong test
 *
 ...
 *
 * @param msg	: message header structure
 *
 * @returns			void
 */
